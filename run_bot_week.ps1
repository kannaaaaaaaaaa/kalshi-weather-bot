...
Write-Host "`n⏱️  Bot will run continuously. Press Ctrl+C to stop.`n" -ForegroundColor Yellow

Write-Host "=" -NoNewline -ForegroundColor Cyan
Write-Host ("=" * 58) -ForegroundColor Cyan
Write-Host ""

# Run the bot and tee output to both console and log file
python main.py 2>&1 | Tee-Object -FilePath $logFile

Write-Host "`n✅ Bot stopped." -ForegroundColor Green
